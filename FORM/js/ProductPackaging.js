 require( ["js/control"
    ...
    function(control,ajax,constantes) {
    	...
    	var Validar=function(){
            ...
            var lstPaisPreferenciaSegunda=$("#lstPaisPreferenciaSegunda");
            var lstOds=$("#lstOds");
    		...
    		else if(lstEntereConvocatoria.val()==""){
    			swal("Seleccione como se entero de la convocatoria");
    			return false;
    		} 
    		else if(lstPaisPreferencia.val()==""){
    			swal("Seleccione su pais de preferencia");
    			return false;
    		} 
    		else if(lstPaisPreferenciaSegunda.val()==""){
    			swal("Seleccione su segundo pais de preferencia");
    			return false;
    		}
    		else if(lstOds.val()==""){
    			swal("Seleccione un ODS");
    			return false;
    		} 
